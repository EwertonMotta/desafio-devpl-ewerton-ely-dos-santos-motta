            ...
            <form action="{{ route('to-do.update', $task) }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="first_name" name="title" value="{{ old('title', $task->title) }}"
                            readonly placeholder="Enviar Relatório Mensal"
                            ...
                            <div class="flex items-center pt-3.5 lg:justify-center">
                                <label class="me-5 inline-flex cursor-pointer items-center">
                                    ...
                                    <input type="checkbox" value="1" class="peer sr-only" name="completed"
                                        id="completed" @checked(old('completed', $task->completed)) />
                                    <div
                ...
                <div>
                    ...
                    <textarea id="message" rows="4" name="description"
                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                        placeholder="Preparar e enviar o relatório mensal de vendas para o gerente de vendas até sexta-feira, 5 de julho. Incluir análise de desempenho, gráficos e principais métricas.">{{ old('description', $task->description) }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                            <span class="font-medium">Ops!</span>
                            {{ $message }}
